/*
  Create structure Train with the following fields:
    First - ID[int type]
    Second - FromAddress[char*]
    Third - ToAddress[char*]
    Fourth - DepartureTime[char*]
  Sort the list of the given N trains by toAddress field and output it.
